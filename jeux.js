//Définition de notre Sprite et de ses élements
...
//Fontion qui gère le début d'une animation (missile ou aliens)
...
//Fonction qui gère l'arrêt d'une animation (missile ou aliens)
Sprite.prototype.stopAnimation = function() {
    window.clearInterval( this._clock );
};

//Fonction qui gère à quel moment se produit une collision
